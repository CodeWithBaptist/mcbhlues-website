...
export function ThemeToggle({ showLabel = false }: { showLabel?: boolean }) {
  ...
  return (
    <button
      ...
      onClick={toggleTheme}
      className={cn(
        "group inline-flex items-center justify-center gap-2 rounded-full border border-gray-200 p-2 text-dark transition-colors hover:border-primary/40 hover:bg-primary/5 hover:text-primary",
